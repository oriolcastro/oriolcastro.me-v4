...
import newCV from '@/assets/OriolCastroArnau_CV_2023.pdf'
import oldCV from '@/assets/OriolCastroArnau_CV_2021.pdf'
...
In our work documentation is key and since looking for a new job was now my full time job I decided to track all applications in Notion. I have been refining this system since my first job hunt.
...
Companies receive hundreds or thousands of applications for a single job position. This has increased due to the current economic situation, not as many jobs as before but more people looking for one.
...
In the first round of applications, I didn't apply to all 111 the same week, I used the same CV I had been using for the last 5 years. It was simple, clean and short, just one page as some experts recommend. The ratio of initial interviews vs. rejections/ghosting was really low.

<a href={oldCV} target="_blank" download>
  {'This was my old CV 😞'}
</a>

After getting a little frustrated, I talked with an ex-colleague that had just been hired and a friend that
...
## Hi! My name is Oriol and I'm a product engineer

Congrats! You survived the first cut now it's your time to shine. The initial interview might not seem important but it's the encounter that will set the tone for all the process.
...
- It's the first impression that the person that will guide you during all the process will get from you.
...
It's a common practice in our industry to assess your technical level during a hiring process. The idea is quite reasonable, if you will be required to do some specific technical work, we should know you are capable of it. The issue is that this has been perverted, creating very bad experiences for candidates, useless insights for companies and an endless debate in the community.

I faced basically all possible combinations of technical tests. I think somewhere were good, others were interesting, and a bunch of others were simply disappointing.

What’s my opinion on that debate? Let me share a few ideas I follow when I'm responsible for assessing the technical level of a candidate.
...
Congrats! If you have survived past the technical assessment, you are very close to complete the process. The last steps are not that standardized, but usually it's what's called a "cultural fit". You will keep doing interviews, but at this point you are the one in control.
...
Having multiple offers sounds nice, but I think it's a double-side sword. You will need to reject all but one offers, and as we have experienced during this process, being the one rejected sucks.
